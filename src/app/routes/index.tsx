...
const DashboardPage = lazy(() => import('../../pages/experience/dashboard/DashboardPage').then(m => ({ default: m.DashboardPage })));
const DataAIPage = lazy(() => import('../../pages/experience/data-ai').then(m => ({ default: m.DataAIPage })));
const FinancePage = lazy(() => import('../../pages/experience/finance/FinancePage').then(m => ({ default: m.FinancePage })));
const MESPage = lazy(() => import('../../pages/experience/mes/MESPage').then(m => ({ default: m.MESPage })));
